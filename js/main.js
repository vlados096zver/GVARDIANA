$(document).ready(function () {
    ...
    function positionImage(){
        let servicesItem = $('.services__item');

        servicesItem.each(function( index, item ) {
            let imageBlock = $(item).find('.services__image');
            let heightItem = imageBlock.height();
            let halfPic= heightItem/2;
             imageBlock.css('top', `calc(100% - ${halfPic}px`);
        })
    }
